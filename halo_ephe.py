...
ax[0][0].set_xlabel('$X_{rot}$ (km)')
ax[0][0].set_ylabel('$Y_{rot}$ (km)')
ax[0][1].grid()
ax[0][1].set_aspect('equal')
ax[0][1].set_xlabel('$X_{rot}$ (km)')
ax[0][1].set_ylabel('$Z_{rot}$ (km)')
ax[1][0].grid()
ax[1][0].set_aspect('equal')
ax[1][0].set_xlabel('$Y_{rot}$ (km)')
ax[1][0].set_ylabel('$Z_{rot}$ (km)')
...
ax[0][0].plot([x_[1] for x_ in XROT],[x_[2] for x_ in XROT] , color = 'blue' , linewidth = 0.3)
ax[0][1].plot([x_[1] for x_ in XROT],[x_[3] for x_ in XROT] , color = 'blue' , linewidth = 0.3)
ax[1][0].plot([x_[2] for x_ in XROT],[x_[3] for x_ in XROT] , color = 'blue' , linewidth = 0.3)
