...
# --- Plot publication-ready de la trajectoire ---
...
# Terre
ax.scatter(0, 0, s=50, color='teal', label='Earth', zorder=5)

# Légende propre
leg = ax.legend(frameon=True, fancybox=True, framealpha=0.9, fontsize=10)
leg.get_frame().set_edgecolor('0.7')

# Marges clean
plt.tight_layout()

dv_tot = universe.evaluables.get('TotalDV_traj').eval(traj2.point('end_pointa'))
print(f'Total dv: {dv_tot*1e3:.3e} m/s')
t_tot = traj2.point('end_pointa') - traj2.point('ctr0a')
